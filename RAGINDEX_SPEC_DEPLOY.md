...
1. Eseguire migrazioni: `cd ragindex && wrangler d1 migrations apply ragindex_db --remote`
2. Eseguire deploy: `wrangler deploy`
...
1. Eseguire deploy dalla root: `npx wrangler pages deploy www --project-name=ragindex-system`
2. Verificare che la directory di destinazione sia `www`.

## FASE 4: SICUREZZA
1. Configurare CLEAR_KEY: `cd ragindex && wrangler secret put CLEAR_KEY`
